//==============================================================================
//
//   Horizon Shaders  -  gbuffers_textured_lit (Overworld, fragment stage)
//
//   GENERATED FILE, do not edit. tools/generate_programs.py writes this wrapper.
//   The program itself lives in shaders/programs/gbuffers_textured_lit.glsl and is shared by the
...
#include "/programs/gbuffers_textured_lit.glsl"
